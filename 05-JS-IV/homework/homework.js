...
function crearGato(nombre, edad) { var objeto= {nombre:nombre, edad:edad, meow: function() 
  {return 'Meow!'}
...
function nuevoUsuario(nombre, email, password) {var objeto= {nombre:nombre, email:email,password:password 
...
function tieneEmail(usuario) {if (usuario.email)  {return true}
...
function verificarPassword(usuario, password) { if (usuario.password===password)  {return true}
else {return false }
